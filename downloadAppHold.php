    ...
    <div class="banner-searchs">
        <div class="row">
            <div class="col-md-6">
                ...
                <h2 style="color: #ffffff; font-size: 13px;text-transform: capitalize; margin-top: 3px " class="text-center">Visit Google PlayStore or Apple App Store to download <?php print  @$siteName?> app </h2>
            </div>
