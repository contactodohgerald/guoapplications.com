    ...
    <div class="banner-searchs" >
        ...
        <div class="row" style="margin-bottom: 0">
            <div class="col-md-6">
                ...
                <h2 style="color: #ffffff; font-size: 13px;text-transform: capitalize; margin-top: 3px " class="text-center">Visit Google PlayStore or Apple App Store to download <span style="color: #f05a23"><?php print  @$siteName?></h2>
            </div>
